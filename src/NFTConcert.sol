...
contract NFTConcert is ERC721 {
    ...
    event e_mintTickets(address userAddress_, uint256 tokenID_);
    ...
    require(currentTokenID < totalSupply, "Tickets Sold Out");
    _safeMint(msg.sender, currentTokenID);
    uint256 id = currentTokenID;
    currentTokenID++;
    emit e_mintTickets(msg.sender, id);
    }
